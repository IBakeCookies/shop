				...
				<fieldset class="flex items-center border-t border-stone-200">
					...
					<div class="flex-1 border-l border-stone-200 p-8">
						<Button
							...
							disabled={stockForSelectedVariation !== null && stockForSelectedVariation === 0}
						>
							Add to cart
						</Button>
					</div>
					...
					{#each productStore.product.productComposition as fabric}
						...
						{#if variation}
							<li>
								...
								{#each variation.fabric_type_composition as composition, i}
									<!-- {#if i === 0}
										[
									{/if} -->
									...
									<!-- {#if i === variation.fabric_type_composition.length - 1}
										]
									{/if} -->
								{/each}
							</li>
